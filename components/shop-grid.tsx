...
export const GRID_PRODUCTS: GridProduct[] = [
  ...
  {
    id: 1,
    name: 'PR PROJECT Racerback Singlet',
    sku: 'FRL-PJ-SGL',
    price: 450,
    img: '/images/PR PROJECT black  singlet (front).png',
    flatImg: '/images/PR PROJECT black  singlet (front).png',
    lifestyleImg: '/images/PR PROJECT Singlet 1 — Front Hero.png',
    detailImages: [
      '/images/PR PROJECT Singlet 1 — Front Hero.png',
      '/images/PR PROJECT Singlet 2 — Three-Quarter Angle.png',
      '/images/PR PROJECT Singlet 3 — Close-Up Chest.png',
      '/images/PR PROJECT Singlet 1 — Front Hero.png',
    ],
  ...
  {
    id: 2,
    name: 'PR PROJECT Speed Suit',
    sku: 'FRL-PJ-SPD',
    price: 999,
    img: '/images/PR PROJECT red speed suit (front)).png',
    flatImg: '/images/PR PROJECT red speed suit (front)).png',
    lifestyleImg: '/images/PR PROJECT Red Speedsuit 1 — Front Hero.png',
    detailImages: [
      '/images/PR PROJECT Red Speedsuit 1 — Front Hero.png',
      '/images/PR PROJECT Red Speedsuit 2 — Three-Quarter Angle.png',
      '/images/PR PROJECT Red Speedsuit 3 — Zipper detail.png',
      '/images/PR PROJECT Red Speedsuit 4 — Back View.png',
    ],
    colors: ['Black', 'White', 'Red'],
  },
  {
    id: 3,
    name: 'PR PROJECT Midriff Crop Top',
    sku: 'FRL-PJ-MDF',
    price: 399,
    img: '/images/PR PROJECT white midriff (front).png',
    flatImg: '/images/PR PROJECT white midriff (front).png',
    lifestyleImg: '/images/PR PROJECT Midriff 1 — Front Hero.png',
    detailImages: [
      '/images/PR PROJECT Midriff 1 — Front Hero.png',
      '/images/PR PROJECT Midriff 2 — Three-Quarter Angle.png',
      '/images/PR PROJECT Midriff 3 — Close-Up Chest.png',
      '/images/PR PROJECT Midriff 4 — Back View.png',
    ],
    colors: ['Black', 'White', 'Red'],
  },
  {
    id: 4,
    name: 'PR PROJECT Crew T-Shirt',
    sku: 'FRL-PJ-TEE',
    price: 550,
    img: '/images/PR PROJECT white tshirt (front).png',
    flatImg: '/images/PR PROJECT white tshirt (front).png',
    lifestyleImg: '/images/PR PROJECT Tshirt 1 — Front Hero.png',
    detailImages: [
      '/images/PR PROJECT Tshirt 1 — Front Hero.png',
      '/images/PR PROJECT Tshirt 2 — Three-Quarter Angle.png',
      '/images/PR PROJECT Tshirt 3 — Close-Up Chest.png',
      '/images/PR PROJECT Tshirt 4 — Back View.png',
    ],
    colors: ['Black', 'White', 'Red'],
  },
]
